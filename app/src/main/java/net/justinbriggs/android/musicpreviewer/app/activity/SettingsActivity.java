...
public class SettingsActivity extends PreferenceActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_is_shown_on_lock_key)));
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        // The ListPreference is tne Lock Screen option
        if (preference instanceof ListPreference) {
            ...
            // Notify SongService that the notification needs to be updated.
            Intent i = new Intent();
            i.setAction(SongService.BROADCAST_NOTIFICATION_UPDATE);
